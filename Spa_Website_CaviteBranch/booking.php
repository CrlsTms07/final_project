          ...
          <form action="submit_booking.php" method="POST">
            ...
            <div class="form-floating mb-3">
              <select class="form-select" id= "service" name="service" required>
                 <option value="Full Body Massage">Full Body Massage - ₱1500</option>
                 <option value="Facials Treatment">Facials Treatment - ₱1800</option>
                 <option value="Collagen Induction Therapy">Collagen Induction Therapy - ₱2000</option>
              </select>
